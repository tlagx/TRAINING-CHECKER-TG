...
let userLanguages: Record<string, string> = {}
...
export const setUserLanguage = async (userId: string, languageCode: string) => {
...
export const loadTranslations = (languageCode: string, namespace: string) => {
  try {
...
export const getTranslation = (languageCode: string, namespace: string, key: string, fallback: string = ''): string => {
...
export const t = (languageCode: string, namespace: string, key: string, params?: Record<string, any>): string => {
  const translations = loadTranslations(languageCode, namespace)
