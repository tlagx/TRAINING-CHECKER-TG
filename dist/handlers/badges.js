...
export const badgesHandler = async (ctx, updateMessage = false) => {
    var _a;
    // Get user language
    ...
    if (updateMessage) {
        await ctx.editMessageText(message, Object.assign({ parse_mode: 'Markdown' }, backKeyboard));
    }
    else {
        await ctx.reply(message, Object.assign({ parse_mode: 'Markdown' }, backKeyboard));
    }
};
